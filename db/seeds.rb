...
sound = user.sounds.create(title: 'Seed Sound 2', description:'NASA Atlas 5 launch')
...
sound = user.sounds.create(title: 'Seed Sound 1', description:'NASA Liftoff')
...
sound = admin.sounds.create(title: 'Seed Sound 3', description:'NASA Beeps')
...
sound = admin.sounds.create(title: 'Seed Sound 4', description:'Daughters of Freedom')
